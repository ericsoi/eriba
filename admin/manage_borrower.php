	...
	<div class="col-lg-12">
		<form id="manage-borrower">
			...
			<div class="row form-group">
				<div class="col-md-6">
					<div class="">
						<label for="">Current Payslip</label>
						<input type="file" class="form-control" name="payslip" value="<?php echo isset($aadhaar) ? $aadhaar : '' ?>">
					</div>
				</div>
				<div class="col-md-6">
					<div class="">
						<label for="">Profile Photo</label>
						<input type="file" class="form-control" name="profile" value="<?php echo isset($pan) ? $pan : '' ?>">
					</div>
				</div>
			</div>
			<!-- <div class="row form-group">
