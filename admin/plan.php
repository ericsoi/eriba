					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<div class="input-group">
								  <input type="number" step="any" min="0" max="31" class="form-control text-right" name="days" aria-label="Interest">
							...
							<div class="form-group">
								...
								<div class="input-group">
								  <input type="number" step="any" min="0" max="100" class="form-control text-right" name="interest_percentage" aria-label="Interest" value=0>
								  <div class="input-group-append">
							...
							<div class="form-group">
								<label class="control-label">Monthly Over due's Penalty after 5 days</label>
								<div class="input-group">
						...
						<table class="table table-bordered">
							...
							<tbody style="background-color: white !important;">
								...
								<tr>
									...
									<td class="">
										 <p><small>Number of Days: <b><?php echo $row['days']. " Days" ?></b></small></p>
										 <p><small>Interest: <b><?php echo $row['interest_percentage']."%" ?></b></small></p>
										 <p><small>Penalty rate: <b><?php echo $row['penalty_rate']."%" ?></b></small></p>
									</td>
