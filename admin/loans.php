				...
				<tbody>
					<?php
						...
						while($row = $qry->fetch_assoc()):
							...
							$penalty1 = $row['amount'] * ($plan_arr[$row['plan_id']]['penalty_rate']/100);
						...
						<td>
							...
							<p><small>KRA No: <b><?php echo $row['aadhaar'] ?></small></b></p>
							<p><small>ID No: <b><?php echo $row['pan'] ?></small></b></p>
						...
						<td>
							...
							<p><small>Overdue Payable Amount: <b><?php echo number_format($penalty1,2) ?></small></b></p>
