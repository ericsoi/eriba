...
<head>
  ...
  <title>Login | ERIBA Ventures</title>
		...
		$('#login-form button[type="button"]').removeAttr('disabled').html('Login');
			...
			success:function(resp){
				...
				if(resp == 1){
					...
					$('#login-form').prepend('<div class="alert alert-danger" style="padding: 3px; margin: 5px; text-align: center; font-size: 14px;">Password invalid.</div>')
					$('#login-form button[type="button"]').removeAttr('disabled').html('Login');
					location.href ='../';
				}else{
